...
<div class="col-md-8">
    <div class="entity_wrapper">
        <div class="entity_title">
            <h1><a href="single.jsp" target="_self">Airbnb launches photo-centric app for iPads and Android tablets.</a>
            </h1>
        </div>
        <!-- entity_title -->
        ...
        <div class="row">
                ...
                <div id="featured-news-carousal" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <img class="img-responsive" src="${contextPath}/public/assets/img/category_img9.jpg" alt="Chania">
                        </div>
                        <!--feature_news_item-->
                        <div class="item">
                            <img class="img-responsive" src="${contextPath}/public/assets/img/category_img13.jpg" alt="Chania">
                        </div>
                        <!--feature_news_item-->
                        <div class="item">
                            <img class="img-responsive" src="${contextPath}/public/assets/img/category_img14.jpg" alt="Chania">
                        </div>
                        <!--feature_news_item-->
                        <div class="item">
                            <img class="img-responsive" src="${contextPath}/public/assets/img/category_img15.jpg" alt="Chania">
                        </div>
                        <!--feature_news_item-->
            ...
            <div class="col-md-5">
                <div class="right_category_image">
                    <img class="img-responsive" src="${contextPath}/public/assets/img/category_img10.jpg" alt="feature-top">
                </div>
                <!--carousel-->

                <div class="right_category_image">
                    <img class="img-responsive" src="${contextPath}/public/assets/img/category_img11.jpg" alt="feature-top">
                </div>
                <!--carousel-->
    ...
    <div class="entity_wrapper">
        ...
        <div class="entity_thumb">
            <img class="img-responsive" src="${contextPath}/public/assets/img/category_img12.jpg" alt="feature-top">
        </div>
        <!-- entity_thumb -->
