        ...
        <div class="row">
            <div class="col-md-7">
                <div class="feature_article_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive top_static_article_img" src="${contextPath}/public/assets/img/feature-top.jpg"
                             alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
            ...
            <div class="col-md-5">
                <div class="feature_static_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive" src="${contextPath}/public/assets/img/feature-static1.jpg" alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
            ...
            <div class="col-md-5">
                <div class="feature_static_last_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive" src="${contextPath}/public/assets/img/feature-static2.jpg" alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
