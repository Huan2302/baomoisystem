                ...
                <div class="col-md-6">
                    <div class="top_article_img">
                        <a href="single.html" target="_self"><img class="img-responsive"
                                                                  src="${contextPath}/public/assets/img/cat-mobi-left-1.jpg" alt="feature-top">
                        </a>
                    </div>
                    <!----top_article_img------>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="category_article_body">
                        <div class="top_article_img">
                            <a href="single.html" target="_self"><img class="img-responsive" src="${contextPath}/public/assets/img/tab_top1.jpg"
                                                                      alt="feature-top">
                            </a>
                        </div>
                        <!-- top_article_img -->
                    ...
                    <div class="category_article_body">
                        <div class="top_article_img">
                            <a href="single.html" target="_self">
                                <img class="img-responsive" src="${contextPath}/public/assets/img/tab_top2.jpg" alt="feature-top">
                            </a>
                        </div>
                        <!-- top_article_img -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="category_article_body">
                        <div class="top_article_img">
                            <a href="single.html" target="_self">
                                <img class="img-responsive" src="${contextPath}/public/assets/img/gad_top1.jpg" alt="feature-top">
                            </a>
                        </div>
                        <!-- top_article_img -->
                ...
                <div class="col-md-6">
                    <div class="category_article_body">
                        <div class="top_article_img">
                            <img class="img-responsive" src="${contextPath}/public/assets/img/gad_top2.jpg" alt="feature-top">
                        </div>
                        <!-- top_article_img -->
        ...
        <div class="category_article_wrapper">
            <div class="row">
                <div class="col-md-5">
                    <div class="top_article_img">
                        <a href="single.html" target="_self">
                            <img class="img-responsive" src="${contextPath}/public/assets/img/cam_left1.jpg" alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->
        ...
        <div class="category_article_wrapper">
            <div class="row">
                <div class="col-md-5">
                    <div class="top_article_img">
                        <a href="single.html" target="_self">
                            <img class="img-responsive" src="${contextPath}/public/assets/img/cam_left2.jpg" alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->
        ...
        <div class="category_article_wrapper">
            <div class="row">
                <div class="col-md-5">
                    <div class="top_article_img">
                        <a href="single.html" target="_self">
                            <img class="img-responsive" src="${contextPath}/public/assets/img/cam_left3.jpg" alt="feature-top">
                        </a>
                    </div>
                    <!-- media_social -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="category_article_body">
                        <div class="top_article_img">
                            <a href="single.html" target="_self">
                                <img class="img-responsive" src="${contextPath}/public/assets/img/design_top1.jpg" alt="feature-top">
                            </a>
                        </div>
                        <!-- top_article_img -->
                ...
                <div class="col-md-6">
                    <div class="category_article_body">
                        <div class="top_article_img">
                            <a href="single.html" target="_self">
                                <img class="img-responsive" src="${contextPath}/public/assets/img/design_top2.jpg" alt="feature-top">
                            </a>
                        </div>
                        <!-- top_article_img -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="category_article_body">
                        <div class="top_article_img">
                            <a href="single.html" target="_self">
                                <img class="img-responsive" src="${contextPath}/public/assets/img/design_top3.jpg" alt="feature-top">
                            </a>
                        </div>
                        <!-- top_article_img -->
                ...
                <div class="col-md-6">
                    <div class="category_article_body">
                        <div class="top_article_img">
                            <img class="img-responsive" src="${contextPath}/public/assets/img/design_top4.jpg" alt="feature-top">
                        </div>
                        <!-- top_article_img -->
