...
<div class="col-md-8">
    <div class="entity_wrapper">
        ...
        <div class="entity_thumb">
            <img class="img-responsive" src="${contextPath}/public/assets/img/category_img_top.jpg" alt="feature-top">
        </div>
        <!-- entity_thumb -->
    ...
    <div class="related_news">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="${contextPath}/public/assets/img/cat-mobi-sm1.jpg"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <span class="tag purple"><a href="category.jsp" target="_self">Mobile</a></span>

                        <h3 class="media-heading"><a href="single.jsp" target="_self">Apple launches photo-centric wrist
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="${contextPath}/public/assets/img/cat-mobi-sm3.jpg"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <span class="tag purple"><a href="category.jsp" target="_self">Mobile</a></span>

                        <h3 class="media-heading"><a href="single.jsp" target="_self">The Portable Charger or data
                            cable</a></h3>
                        <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Eric joan</a></span>
            ...
            <div class="col-md-6">
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="${contextPath}/public/assets/img/cat-mobi-sm2.jpg"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <span class="tag purple"><a href="category.jsp" target="_self">Mobile</a></span>

                        <h3 class="media-heading"><a href="single.jsp" target="_self">Iphone 6 launches white & Grey
                            colors handset</a></h3>
                        <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Eric joan</a></span>
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="${contextPath}/public/assets/img/cat-mobi-sm4.jpg"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <span class="tag purple"><a href="category.jsp" target="_self">Mobile</a></span>
                        <a href="single.jsp" target="_self"><h3 class="media-heading">Fully new look slim handset
                            like</h3></a>
                        <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Eric joan</a></span>
    ...
    <div class="widget_advertisement">
        <img class="img-responsive" src="${contextPath}/public/assets/img/category_advertisement.jpg" alt="feature-top">
    </div>
    <!--Advertisement-->
    ...
    <div class="readers_comment">
        ...
        <div class="media">
            <div class="media-left">
                <a href="#">
                    <img alt="64x64" class="media-object" data-src="${contextPath}/public/assets/img/reader_img1.jpg"
                         src="${contextPath}/public/assets/img/reader_img1.jpg" data-holder-rendered="true">
                </a>
            </div>
            <div class="media-body">
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#">
                            <img alt="64x64" class="media-object" data-src="${contextPath}/public/assets/img/reader_img2.jpg"
                                 src="${contextPath}/public/assets/img/reader_img2.jpg" data-holder-rendered="true">
                        </a>
                    </div>
                    <div class="media-body">
        ...
        <div class="media">
            <div class="media-left">
                <a href="#">
                    <img alt="64x64" class="media-object" data-src="${contextPath}/public/assets/img/reader_img3.jpg"
                         src="${contextPath}/public/assets/img/reader_img3.jpg" data-holder-rendered="true">
                </a>
            </div>
            <div class="media-body">
